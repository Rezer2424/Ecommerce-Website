...
export default function Grilla({ productFiltered }) {
    ...
    if (productFiltered.length === 0 && (sortByCat || color || minPrice || maxPrice || rating)) {
        return <Stack justifyContent='center' padding='50px' boxShadow='md' borderWidth='2px' directin='column' alignItems='center' bg='white'><WarningIcon w={150} h={150} color="red.500" width='650px' />
